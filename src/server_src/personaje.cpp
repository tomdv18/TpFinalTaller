...
Personaje::Personaje(uint32_t id_jugador):
        id_jugador(id_jugador), posicion_x(150), posicion_y(100), vida(100), esta_quieto(0), arma(), velocidad_x(0), velocidad_y(0){
    corriendo = false;
...
void Personaje::actualizar_posicion(std::chrono::duration<double> tiempo_transcurrido,
    ...
    //velocidad_y += saltando ? GRAVEDAD * delta_tiempo : 0;
